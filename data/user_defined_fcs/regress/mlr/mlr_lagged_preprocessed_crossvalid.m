function [r2_acc,r2_pred,sse_acc,sse_pred] = mlr_lagged_preprocessed_crossvalid(X,Y,k)
...
for i=1:k
   if i ~= k
    ...
    %Training
    [beta_mlr] = lsmlr_lagged_preprocessed(TrainingX,TrainingY);
    y_mlr = mlr_lagged_preprocessed_regressor(beta_mlr,TrainingX);
    y_mlrp = mlr_lagged_preprocessed_regressor(beta_mlr,TestX);
