function [r2_acc,r2_pred,sse_acc,sse_pred,beta_best,Rn,R2_best] = filtered_pmlr_crossvalid(X,Y,k,L,bf,af)
...
for i=1:k
   if i ~= k
    ...
    y_mlr = mlr_regressor(beta_mlr,TrainingX,bf,af);  
    y_mlrp = mlr_regressor(beta_mlr,TestX,bf,af);
