...
function [F1,D1,F2,D2,FeaturesSession_x,FeaturesSession_y,targetSession] = getTrainingSetsMLR(sim_out,BufferLength,phase,dim,Nsd_in,all)
%GETTRAININGSETS ,Wanted Training Sets From Simulation Data
%Get BufferLength Latest Data

[betaSession_x,statsSession_x,dxySession,...
