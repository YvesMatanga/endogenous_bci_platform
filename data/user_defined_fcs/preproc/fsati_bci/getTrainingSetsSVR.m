function [F1,D1,F2,D2] = getTrainingSetsSVR(sim_out,BufferLength,phase,MaxSvs,dim,Nsd_in,all)
%GETTRAININGSETS ,Wanted Training Sets From Simulation Data
%Get BufferLength Latest Data

[modelParametersSession_x,statsSession_x,dxySession,...
    ...
    if ~isempty(targetSession)
        ...
        for i=Start:NSets
            ...
            if(phase==1)%horizontal
                 [Fx,Dx] = getDataSetx(FeaturesSession_x{a},targetSession{a},dxySession{a},Nsd,all);%get all data
